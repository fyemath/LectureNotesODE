...
\begin{proposition}[Constructing Integrating Factor]\label{prop:intfactor} Given a differential equation $ M(x,y) \D x +  N(x,y) \D y =0$, suppose that $M$, $N$, $\frac{\partial M}{\partial x}$ and $\frac{\partial N}{\partial y}$ are continuous. Then  
